...
///  ==================== SPARSE GRID ====================
    ...
    void ResultSecretary::exportForTables(std::ofstream & myfile) const
    {
        ...
        myfile << ",,,,,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Cell iteration,Square,Corridor,Z,2 pillars,4 pillars,,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Sparse Grid 2D," << getResult(circle, sparseGrid_2d).cellIterations << "," << getResult(circle, sparseGrid_2d).cellIterations << "," << getResult(circle, sparseGrid_2d).cellIterations << "," << getResult(circle, sparseGrid_2d).cellIterations << "," << getResult(circle, sparseGrid_2d).cellIterations << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Sparse Grid 3D," << getResult(circle, sparseGrid_3d).cellIterations << "," << getResult(circle, sparseGrid_3d).cellIterations << "," << getResult(circle, sparseGrid_3d).cellIterations << "," << getResult(circle, sparseGrid_3d).cellIterations << "," << getResult(circle, sparseGrid_3d).cellIterations << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Regular Grid 2D," << getResult(circle, regularGrid_2d).cellIterations << "," << getResult(circle, regularGrid_2d).cellIterations << "," << getResult(circle, regularGrid_2d).cellIterations << "," << getResult(circle, regularGrid_2d).cellIterations << "," << getResult(circle, regularGrid_2d).cellIterations << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Regular Grid 3D," << getResult(circle, regularGrid_3d).cellIterations << "," << getResult(circle, regularGrid_3d).cellIterations << "," << getResult(circle, regularGrid_3d).cellIterations << "," << getResult(circle, regularGrid_3d).cellIterations << "," << getResult(circle, regularGrid_3d).cellIterations << ",,,,,,,,,,,,,,,,,,,,,,\n";
        
        

        myfile << ",,,,,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << ",Analysed  2D,Unknown 2D,Analysed 3D,Unknown 3D,,,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Room,";
        exportAnalysedFragment(circle, twoD, myfile);
        exportAnalysedFragment(circle, threeD, myfile);
        myfile << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Corridor,";
        exportAnalysedFragment(double_circle, twoD, myfile);
        exportAnalysedFragment(double_circle, threeD, myfile);
        myfile << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "Z,";
        exportAnalysedFragment(s, twoD, myfile);
        exportAnalysedFragment(s, threeD, myfile);
        myfile << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "2 pillars,";
        exportAnalysedFragment(oil, twoD, myfile);
        exportAnalysedFragment(oil, threeD, myfile);
        myfile << ",,,,,,,,,,,,,,,,,,,,,,\n";
        myfile << "3 pillars,";
        exportAnalysedFragment(oil_larger, twoD, myfile);
        exportAnalysedFragment(oil_larger, threeD, myfile);
        myfile << ",,,,,,,,,,,,,,,,,,,,,,\n";
       
    }

    void ResultSecretary::exportAnalysedFragment(Scenario scenario, Directions dim, std::ofstream & myfile) const
    {
        int analysed, total;
        if(dim == twoD)
        {
            analysed = getResult(scenario, regularGrid_2d).cellIterations;
            total = getResult(scenario, sparseGrid_2d).cellIterations;
        }
        else
        {
            analysed = getResult(scenario, regularGrid_3d).cellIterations;
            total = getResult(scenario, sparseGrid_3d).cellIterations;
        }
        int unknown = total - analysed;
        myfile << analysed << "," << unknown << ",";
    }
